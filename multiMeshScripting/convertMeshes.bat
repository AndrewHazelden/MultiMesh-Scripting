...
echo.
echo MultiMesh Scripting - Convert Meshes v1.1
...
rem The available -m options are:
...
rem Example Syntax: 
rem "C:\Program Files\VCG\MeshLab\meshlabserver.exe" -i input\boulder-mini1.ply -o output\boulder-mini1.ply -m vc fq wn
...
rem for %%I in (*.%inputMeshFormat%) do (%meshlabserverPath% -i %%I -o ..\%outputFolder%\%%~nI.%outputMeshFormat% %outputMeshOptions% -s ..\%mlxScriptFolder%\%mlxScriptFile%)
rem To get help on the "for" syntax use: for /?
